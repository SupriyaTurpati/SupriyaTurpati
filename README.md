...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:8E2DE2,100:4A00E0&height=180&section=header&text=Hi%20there!%20I'm%20Supriya%20👋&fontSize=38&fontColor=ffffff&animation=fadeIn&fontAlignY=38" width="100%"/>

<a href="https://git.io/typing-svg">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=24&duration=3000&pause=1000&color=8E2DE2&center=true&vCenter=true&width=600&lines=Student+at+N+S+Raju+Institute+of+Engineering+%26+Technology;Building+with+Code%2C+Curiosity+%26+Coffee+%E2%98%95;Turning+Ideas+into+Interfaces+%F0%9F%92%BB;Always+Learning%2C+Always+Building+%F0%9F%9A%80" alt="Typing SVG" />
</a>
...
I'm **Supriya Turpati**, a curious and driven student who loves turning lines of code into things that actually work (and hopefully look good too 😄). I'm currently exploring the exciting intersection of **web development**, **data analytics**, and **AI tools** — and having a great time doing it.

- 🎓 Currently studying at **N S Raju Institute of Engineering and Technology**
- 💻 I enjoy building things with **React, Node.js, and JavaScript** — bonus points if it has a clean UI
- 📊 I have a soft spot for **data** — Power BI and Excel make me weirdly happy
- 🤖 Big fan of **AI-powered tools** like ChatGPT, Gemini, and Claude — I use them to learn faster and build smarter
- 🌱 Still growing my skills in **DSA, OOP, and SQL** — one concept at a time
- ✨ Believe in clean code, good design, and never-ending curiosity
